...
export class ListView extends ItemView {
  ...
  public async setTasks(): Promise<void> {
    console.log("Actualizando tareas en vista lista"); // Debugging line
  ...
  private async renderTemplate(container: HTMLElement): Promise<void> {
    const templatePath = this.app.vault.adapter.getResourcePath('.obsidian/plugins/obsidian-agenda/templates/list-view.hbs');
